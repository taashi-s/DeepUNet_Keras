...
class DataGenerator():
    ...
    def load_data(self, name):
        ...
        #teacher_img_re = teacher_img
        #teacher_img_re[teacher_img_re == 1] = 2
        #teacher_img_re[teacher_img_re == 0] = 1
        #teacher_img_re[teacher_img_re == 2] = 0
        return input_img, teacher_img#np.stack([teacher_img,teacher_img_re], axis=2)
